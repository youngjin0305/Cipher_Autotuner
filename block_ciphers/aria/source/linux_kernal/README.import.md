...
Upstream source:
- Linux kernel x86 ARIA AES-NI/AVX, AES-NI/AVX2, and GFNI/AVX-512 implementation files
...
- `gfni_avx512/aria-gfni-avx512-asm_64.S`
- `gfni_avx512/aria_gfni_avx512_glue.c`
...
- Userspace wrappers live under `block_ciphers/aria/impl/linux_aesni_avx/`,
  `block_ciphers/aria/impl/linux_aesni_avx2/`, and
  `block_ciphers/aria/impl/linux_gfni_avx512/`.
